...
<html>
	...
	<body style="background:url('imgweb/allmain.jpg'); background-size: cover;">
		<div style="border:5px solid #fc0fc0; border-radius:2px; text-align:center; height:630px; width:980px; background-image:url('imgweb/cmple2.jpg'); background-size:cover; margin:70px 0 0 300px;">
